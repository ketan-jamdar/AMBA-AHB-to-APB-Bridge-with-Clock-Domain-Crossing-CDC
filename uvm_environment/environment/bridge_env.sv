...
function void build_phase(uvm_phase phase);
    ...
    // Give scoreboard access to coverage component
...
function void connect_phase(uvm_phase phase);
    ...
    // AHB monitor -> Scoreboard
    ahb_agnt.mon.ap.connect(
        sb.ahb_imp
    );

    // AHB monitor -> Functional Coverage
    ahb_agnt.mon.ap.connect(
        cov.analysis_export
    );

    // APB monitor -> Scoreboard
    apb_agnt.mon.ap.connect(
        sb.apb_imp
    );
